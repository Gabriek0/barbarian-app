...
export function RegistrationScreen() {
  ...
  const { handleRegistration, isLoading } = useAuthContext();
  ...
  return (
    <Container>
      ...
      <Input
        ...
        onChangeText={(value) => handleInputs(value, 'confirmPassword')}
      />
      <Button onPress={sendToHandleRegistration}>
        <ButtonText>{isLoading ? <Loading /> : 'Confirmar'}</ButtonText>
      </Button>
    </Container>
  );
}
